...
Балансировка на уровне L4 обеспечит:
- Распределение трафика между серверами.
- Учет количества активных соединений.
  
На уровне L4 можно использовать nginx

Также балансировка на уровне L7 обеспечит:
...
На уровне L7 будем использовать балансировщик Envoy
...
![image](https://github.com/flioletty/highload/assets/92665311/f3cb425f-1ca9-439a-86bf-05a83246f61f)
