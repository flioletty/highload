![image](https://github.com/flioletty/highload/assets/92665311/deb41cee-ef2b-47a7-9d3c-e1fbb8837a5f)# Проектирование высоконагруженного почтового сервиса
...
![image](https://github.com/flioletty/highload/assets/92665311/5d72d7a4-c173-4408-b076-94b26394b983)
...
- Если отправитель является государственным сервисом, который занесен в базу (например, Госуслуги, Росреестр, ФНС и др.), письмо помещается в специальную папку “Госписьма”.
