...
![image](https://github.com/flioletty/highload/assets/92665311/05aff48b-6c23-4e0b-a61f-048fa9f7a472)
...
- При отказе сервиса `searcher` можем делать поиск полных совпадений по словам писем по бд где хранятся письма (медленно, но хоть как-то)
